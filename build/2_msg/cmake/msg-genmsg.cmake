...
set(MSG_I_FLAGS "-Imsg:/home/lsklsk/task/question1/src/2_msg/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lsklsk/task/question1/src/2_msg/msg/req.msg" NAME_WE)
add_custom_target(_msg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "msg" "/home/lsklsk/task/question1/src/2_msg/msg/req.msg" ""
)
...
_generate_msg_cpp(msg
  "/home/lsklsk/task/question1/src/2_msg/msg/req.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/msg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/msg\")")
  # install generated code
  install(
